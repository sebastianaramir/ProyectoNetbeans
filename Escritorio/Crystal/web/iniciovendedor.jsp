  ...
  <div class="container-fluid">
    ...
    <div>
      <ul class="nav navbar-nav">
        ...
        <li><a href="quienessomos.html">PRODUCTOS</a></li>
        <li><a href="dondeestamos.html">CLIENTES</a></li> 
        <li><a href="franquicias.html">RANKING</a></li> 
        <li><a href="franquicias.html">FACTURAR</a></li>
      </ul>
    </div>
  </div>
</nav>
